...
useEffect(()=>{
  ...
  return (
    <SafeAreaView className='flex-1 bg-surface' edges={['top']}>
        <Header title='Barber Shop' showBack showCart/>
        <View className='flex-row gap-2 mb-3 mx-4 my-2'> 
            ...
            <View className='flex-1 flex-row items-center bg-white rounded-xl border border-gray-100'>
                ...
                <TextInput className='flex-1 ml-2 text-primary px-4 py-3' placeholder='Search Hair Cut...'
            ...
            ListEmptyComponent={
                !loading && (
                    <View className='flex-1 items-center justify-center py-20'>
                        <Text className='text-secondary'>No Haircut Found</Text>
                    </View>
                )
            }
            />
