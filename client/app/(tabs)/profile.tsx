...
const handleLogout = async () => {
  ...
  return (
    <SafeAreaView className='flex-1 bg-surface' edges={['top']}>
      ...
      contentContainerStyle={!user ? {flex: 1, justifyContent: 'center', alignItems: 'center'} : {padding: 16}}>
        {!user ? (
          //guest
          <View className='items-center w-full'>
            ...
            <Text className='text-secondary text-base mb-8 text-center w-3/4 px-4'>Please log in to view your profile and access personalized features.</Text>
            <TouchableOpacity
            onPress={()=>router.push('/sign-in')}
            className='bg-primary w-3/5 rounded-full py-3 items-center shadow-lg'>
          ...
          <>
            ...
            <View className='items-center mb-8'>
              ...
              <View className='mb-3'>
                ...
                className='size-20 border-2 border-white rounded-full'/>
              </View>
            ...
            onPress={handleLogout}>
              <Text className='text-red-500 font-bold ml-2 text-center'>Logout</Text>
            </TouchableOpacity>
          </>
